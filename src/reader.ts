...
<style>body{max-width:46rem;margin:2rem auto;padding:0 1rem;font:1.1rem/1.8 system-ui,sans-serif;color:#202124}article{overflow-wrap:anywhere}section{margin:2rem 0;padding-top:1rem;border-top:1px solid #ddd}figure{margin:1.5rem 0}img{display:block;max-width:100%;height:auto;border-radius:.5rem}p{margin:.8rem 0}</style>
</head>
<body><main><article><header><h1>微博正文</h1></header>${sections}</article></main></body>
</html>`;
}
